...
const SubadminDashboard = () => {
  ...
  const handleActiveInactiveUser = () => {
    ...
    if (user && user._id) {
      dispatch(activeInactiveUser({ user: user._id, status }));
    }
    setUser("");
  ...
  return (
    <React.Fragment>
      ...
      <Container fluid className="py-4 ">
        <Row className="mb-4">
          <Col>
            <h3 className="text-Primary">Sub Admin Dashboard</h3>
            <span className="text-muted">Manage User</span>
          </Col>
          {role === "sub_admin" && (
